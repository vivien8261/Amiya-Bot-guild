...
from amiyabot.builtin.message.builder import text_convert
...
async def _(data: Message):
    ...
    is_main_guild = data.guild_id == '16459499741255637771'
    ...
    if r:
        ...
        if check_permissible(replace):
            return save_replace(data, origin, replace, int(is_main_guild))
